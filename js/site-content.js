window.SITE_DATA = {
  ...
  projects: [
    ...
    },
    {
      id: 3,
      title: "盲见",
      description: "盲见项目作品集，项目详情与过程材料请查看 PDF 作品集。",
      tags: ["项目作品集", "产品设计"],
      image: "",
      link: "#",
      date: "待定",
      pdf: "assets/pdfs/mangjian.pdf"
    }
  ],
  posts: [
    {
    ...
    },
    {
      id: 2,
      title: "欢迎来到我的记录博客",
      excerpt: "记录一个网站从想法到落地的过程，也记录学习、项目和日常里的小进步。",
      tags: ["博客", "技术", "生活"],
      date: "2026-06-15",
      content: "## 欢迎来到我的记录博客\n\n这里会慢慢放进我的项目、日常和一些想法。\n\n我希望它不只是一个展示页，而是一个能不断更新、不断长大的个人空间。"
    }
  ]
};
